  ...
  return (
    <main className="min-h-screen bg-[#f6fafb] px-4 py-6 text-slate-950 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-4xl gap-6">
        <header>
          <Link className="text-sm font-semibold text-cyan-700 hover:text-cyan-900 transition-colors" href="/payments">Payment records</Link>
        ...
        {residents.length > 0 ? (
          ...
          <div className="rounded-xl border border-border-subtle bg-white p-6 text-sm text-slate-600 shadow-sm">
